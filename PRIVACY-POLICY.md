All data stored by this application is retrieved from Plex except as described below

Refer to the Plex Privacy Policy for more details: https://www.plex.tv/about/privacy-legal/

Log and usage data is collected as per the below policy:
...
- __Application__ means the software program provided by the Company downloaded by You on any electronic device, named Plex AAOS


- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Plex AAOS.
...
- By visiting this page on our website: [https://github.com/joeyberkovitz/plex-aaos](https://github.com/joeyberkovitz/plex-aaos)
